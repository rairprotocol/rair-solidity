...
describe("Diamonds", function () {
	...
	describe("Minter Marketplace", () => {
		...
		describe("ERC721 Security", () => {
			it ("Shouldn't be able to call any of the Factory's functions", async () => {
				...
				/*
					...
					console.log(Object.keys(diamondCut.functions));
					console.log(Object.keys(diamondFacet.functions));
					console.log(Object.keys(tokenReceiverFacet.functions));
				*/
			});
		...
		describe("Factory Security", () => {
			...
			it ("Shouldn't create ranges", async () => {
				...
				await expect(rangesFacet.createRange(0, 10, 1000, 9, 5, 'First First First')).to.be.reverted;
			});
